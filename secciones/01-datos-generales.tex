...
\section{Descripción de la Institución pública}
...
\subsection{Ubicación, sector y actividades que realiza}
...
Las prácticas fueron realizadas en el \textbf{Departamento de Inteligencia Artificial y Ciberseguridad} de INNOVA IRV, bajo el liderazgo del Ing. Natanael Pérez Bucio, quien actuó también como mi tutor de la entidad colaboradora. La modalidad fue \textbf{100\,\% presencial}, en la sede de la Fundación en el Parque Tecnológico de Andalucía (PTA), Málaga.
...
\textbf{Alianzas estratégicas:} INNOVA IRV articula una estructura piramidal de colaboración entre centros tecnológicos: Eurecat, ITA, Tecnalia (que aportan prestación de servicios), y universidades: Universidad de Málaga, Universidad de Granada, Universidad de Sevilla, Universidad Internacional de Andalucía (que aportan provisión de talento). Sobre dicha estructura se desarrollan proyectos de innovación e investigación público-privados que culminan en grandes iniciativas transformadoras. A nivel internacional, se integra en el ecosistema europeo de semiconductores y microelectrónica: el Imec, la European Semiconductor Regions Alliance, y los centros de competencias europeos de semiconductores (CSA).
